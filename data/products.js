...
class Clothing extends Product {
  // clothing inherits everything from Product
  sizeChartLink; //"images/clothing-size-chart.png"

  constructor(productDetails) {
    super(productDetails); // basically calls the constructor of the parent class (Product)
    this.sizeChartLink = productDetails.sizeChartLink;
  }

  extraInfoHTML() {
    return `
    <a href = "${this.sizeChartLink}" target = "_blank"> <!-- link opens in a new tab -->
      Size chart
    </a>
    `;
  }
...
const date = new Date();
console.log(date);
console.log(date.toLocaleTimeString()); // gives the time in the user's local time zone
*/
/*
console.log(this);
...
const object2 = {
  a: 2,
  b: this.a // at this point, object 2 has not been created thus being undefined
}
*/
/*
function logThis() {
  console.log(this); // undefined because this function is not inside an object
}
logThis();
logThis.call("hello"); // does the same thing as above except we can pass a value for 'this'

const object3 = {
  method: () => {
    console.log(this); // arrow functions do not change the value of 'this', it will be same as as if it was outside, in this case undefined.
  }
};
*/
/*
...
3. Arrow functions do not change the value of 'this', it will be same as as if it was outside
*/
...
export function loadProductsFetch() {
  const promise = fetch("https://supersimplebackend.dev/products")
    .then((response) => {
      return response.json(); //gives us the json or the "data" attached to the response
    })
    .then((productsData) => {
...
//loadProductsFetch().then(()=>{}) could add another promise;
